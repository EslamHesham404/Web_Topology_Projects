 ...
 *
 * Run: Eulerian Path Directed Edges AdjacencyList
 * Time Complexity: O(E)
 *
 * @author Eslam Hesham
 */
...
public class Euler {
    ...
    private int[] in, out;
    private LinkedList<Integer> path; // store eulerian path solution
    private List<List<Integer>> graph;

    public Euler(List<List<Integer>> graph) {
