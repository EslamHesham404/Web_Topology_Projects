/*
 * An implementation of the Ford-Fulkerson method with a DFS for finding augmenting paths.
 * <p>Time Complexity: O(fE), where f is the max flow and E is the number of edges.
 * Author: Eslam Hesham Ahmed
 */
...
public class FordFulkerson {
    ...
    private static class FordFulkersonDfsSolver extends NetworkFlowSolverBase {
        ...
        // return bottleneck value found along the augmenting path.
